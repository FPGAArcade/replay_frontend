...
static MENU_ITEMS: [MenuItemInfo; MENU_SELECTION_NAMES_COUNT] = [
    MenuItemInfo { text: "Search", path: "data/svgs/search.svg", selection_id: MenuSelection::Search },
    MenuItemInfo { text: "Systems", path: "data/svgs/home.svg", selection_id: MenuSelection::Systems },
    MenuItemInfo { text: "Games", path: "data/svgs/charts.svg", selection_id: MenuSelection::Games },
    MenuItemInfo { text: "Demos", path: "data/svgs/radio.svg", selection_id: MenuSelection::Demos },
    MenuItemInfo { text: "Settings", path: "data/svgs/playlist.svg", selection_id: MenuSelection::Settings },
    MenuItemInfo { text: "Debug", path: "data/svgs/history.svg", selection_id: MenuSelection::Debug },
];
...
impl LeftSideMenu {
    ...
    fn calculate_layout(&mut self, width: u32, height: u32) -> flowi::Result<()> {
        ...
        let logo_size = Vec2 { x: logo_info.width as f32, y: logo_info.height as f32 }; 
