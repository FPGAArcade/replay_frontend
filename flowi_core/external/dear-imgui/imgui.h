...
struct ImDrawList
{
    ...
    IMGUI_API void  AddImageColor(ImTextureID user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min, const ImVec2& uv_max, 
    ...
    IMGUI_API void  PrimRectUVColor(const ImVec2& a, const ImVec2& b, const ImVec2& uv_a, const ImVec2& uv_b, ImU32 col0, ImU32 col1, ImU32 col2, ImU32 col3);
